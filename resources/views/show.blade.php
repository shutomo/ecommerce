                ...
                <div class="card-body row">
                    ...
                    <div class="col-md-8" style="min-height: 500px">
                        ...
                        <div class="mt-2">
                            <br>
                            <span>Share :</span>
                            <a href="https://facebook.com/sharer/sharer.php?u{{route('detail', ['id'=>$product->id])}}" class="social-button fab fa-facebook-f" target="_blank"></a>
                            |
                            <a href="https://twitter.com/intent/tweet?text=my share text&amp;url={{route('detail', ['id'=>$product->id])}}" class="social-button fab fa-twitter" target="_blank"></a>
                            |
                            <a href="https://linkedin.com/shareArticle?mini=true&amp;title=my share text&amp;sumary=dit is de linkedin summary" class="social-button fab fa-linkedin" target="_blank"></a>
                            |
                            <a href="https://wa.me/?text={{route('detail', ['id'=>$product->id])}}" class="social-button fab fa-whatsapp" target="_blank"></a>
                        </div>
                        <hr>
                                ...
                                <div class="box box-danger">
                                    ...
                                    <div class="box-body">
                                        ...
                                        <form id="form_review" method="post">
                                            <input type="hidden" value="{{$product->id}}" name="idProduct" id="idProduct">
                                            @csrf
