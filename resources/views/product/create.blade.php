                ...
                <div class="card-body">
                    ...
                    <form method="POST" enctype="multipart/form-data" action="{{route('admin.products.store')}}">
                            ...
                            <div class="col-md-6">
                                <div class="input-group control-group control-image increment-image" >
                                    ...
                                    <!-- <div class="input-group-btn"> 
                                        <button class="btn btn-success btn-image" type="button"><i class="glyphicon glyphicon-plus"></i>Add</button>
                                    </div> -->
                                </div>
                                ...
                                <!-- <div class="clone-image hide">
                                    ...
                                    <input type="file" name="filename[]">
                                        <div class="input-group-btn"> 
                                            <button class="btn btn-danger btn-danger-image" type="button"><i class="glyphicon glyphicon-remove"></i> Remove</button>
                                        </div>
                                  </div>
                                </div> -->
                                @if ($errors->has('image'))
                        ...
                        <div class="form-group row">
                                ...
                                <!-- <div class="clone-video hide">
                                    <div class="control-group control-video input-group" style="margin-top:10px">
                                    <input type="file" name="filevideo[]">
                                        <div class="input-group-btn"> 
                                            <button class="btn btn-danger btn-danger-video" type="button"><i class="glyphicon glyphicon-remove"></i> Remove</button>
                                        </div>
                                  </div>
                                </div> -->
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-12">
                                <textarea style="" id="description" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="description" value="{{ old('description') }}">{{old('description')}}</textarea>
